...
def errorQuestion1(val, lowerBound, upperBound, error): # inspired from ControlGameDriver by Sam
    while True: 
...
def intro():
    ...
    return errorQuestion1("Please enter a command (0, 1, 2, 3, 4, 5 or 6): ", 0, 6, error1)
